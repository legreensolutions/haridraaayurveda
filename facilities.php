...
$page = new gsPage;
	...
	$page->page_name = 'facilities';		// page name for menu and other purpose
	$page->layout = 'haridraa_facilities.html';		// layout name
	...
	$index++;
	$content_list[$index]['file_name']='inc_facilities.php';
