...
$page = new gsPage;
    ...
    $page->page_name = 'language_search';     // page name for menu and other purpose
    ...
    $page->class_list = array("class_gspagination.php","class_user.php","class_language.php");
